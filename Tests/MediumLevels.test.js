...
describe("MediumLevels tests", () => {
  const navigation = {
    navigate: jest.fn(),
  };

  it("Renders the Medium Levels data", () => {
    const { getByText } = render(
      <CreditsContext.Provider value={mockCredits}>
        <MediumLevelsScreen navigation={navigation} levels={levelData} />
      </CreditsContext.Provider>
    );
    expect(getByText("Medium Levels")).toBeTruthy();
  });
